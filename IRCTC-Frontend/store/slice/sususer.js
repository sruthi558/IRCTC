...
export const sususerSlice = createSlice({
	name: "susUser",
	initialState: {
		pageNumber: 1,
		data: [],
...
export const { changeSearchToggle, changeSearchValue, changeFilterOption, changeDate, initTotalPageCount, initPageCount, initData, initChangePageNumber, initCount } = sususerSlice.actions

export default sususerSlice.reducer
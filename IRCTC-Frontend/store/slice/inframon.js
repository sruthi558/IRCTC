...
export const { initModalData, changeSearchToggle, changeSearchValue, changeFilterOption, changeDate, initTotalPageCount, initPageCount, initData, initChangePageNumber, initCount } = infraSlice.actions
